# Keon FUG Console — Svelte

A control console for an **already-provisioned** Keon device over the Feel Unified Gateway (FUG) REST transport — the recommended transport for most integrations.
